...
namespace Lean.Transition
{
    ...
    public class LeanManualAnimation : MonoBehaviour
    {
        ...
        public LeanPlayer Transitions { get { if (transitions == null) transitions = new LeanPlayer(); return transitions; } }
        [SerializeField][UnityEngine.Serialization.FormerlySerializedAs("Transitions")] private LeanPlayer transitions;
...
namespace Lean.Transition.Editor
{
    ...
    public class LeanManualAnimation_Editor : CwEditor
    {
        protected override void OnInspector()
        {
            ...
            //Draw("OnCompleted", "When The Transitions End");
        }
    }
}
#endif
